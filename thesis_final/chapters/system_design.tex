...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{figures/cctv.jpg}
\caption{CCTV Camera Installation Setup for Roadside Traffic Monitoring - Animation View showing camera placement and coverage area}
\label{fig:cctv_installation}
\end{figure}
