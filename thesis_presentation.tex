...
\begin{frame}{Research Methodology Overview}
    \begin{center}
        \begin{tikzpicture}[scale=0.9]
            \node[draw, rectangle, minimum width=2.5cm, minimum height=1cm] (data) at (0,2) {Data Collection};
            \node[draw, rectangle, minimum width=2.5cm, minimum height=1cm] (model) at (3,2) {Model Development};
            \node[draw, rectangle, minimum width=2.5cm, minimum height=1cm] (system) at (6,2) {System Design};
            \node[draw, rectangle, minimum width=2.5cm, minimum height=1cm] (impl) at (3,0) {Implementation};
            \node[draw, rectangle, minimum width=2.5cm, minimum height=1cm] (eval) at (6,0) {Evaluation};
        ...
        \begin{column}{0.5\textwidth}
            \begin{center}
                \begin{tikzpicture}[scale=0.7]
                    \node[draw, rectangle, minimum width=2cm, minimum height=1cm] (camera) at (0,3) {CCTV Camera};
                    \node[draw, rectangle, minimum width=2cm, minimum height=1cm] (yolo) at (0,1.5) {YOLOv11 Model};
                    \node[draw, rectangle, minimum width=2cm, minimum height=1cm] (controller) at (0,0) {Traffic Controller};
                    \node[draw, rectangle, minimum width=2cm, minimum height=1cm] (signals) at (0,-1.5) {Traffic Signals};
                    
                    \draw[->] (camera) -- (yolo);
                    \draw[->] (yolo) -- (controller);
                    \draw[->] (controller) -- (signals);
                    
                    \node[right] at (2.5,3) {Live Video Stream};
                    \node[right] at (2.5,1.5) {Object Detection};
                    \node[right] at (2.5,0) {WJF Algorithm};
                    \node[right] at (2.5,-1.5) {Signal Control};
                \end{tikzpicture}
            \end{center}
        \end{column}
        \begin{column}{0.5\textwidth}
            \begin{figure}[h]
                \centering
                \includegraphics[width=0.9\textwidth]{thesis_final/figures/8.png}
